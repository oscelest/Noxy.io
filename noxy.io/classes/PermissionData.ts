...
export default class PermissionData {
  ...
  public hasPermission(permission: PermissionLevel) {
    ...
    if (value === null) throw new Error(`Permission '${permission}' does not exist.`);
    return typeof value === "object" ? _.every(value) : value;
  }

  public isAdmin() {
    return _.every(PermissionLevel, permission => _.get(this, permission));
  }
...
export type PermissionJSON = PermissionObject<Properties<PermissionData>>
